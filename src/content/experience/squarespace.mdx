...
Implemented product features across the tech stack for an application that helps restaurant managers and hosts manage reservations. This included: bookings, menus, check-ins, and payment/refunds while considering real-time device syncing and user accessibility issues.
...
* Added functionality and enhanced the reservation management application’s performance, which increased Restaurant Host user satisfaction and reduced maintenance overhead for product team members.
